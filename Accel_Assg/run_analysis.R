...
actNames<-read.table("./UCI HAR Dataset/activity_labels.txt",header=F,
                     sep="")

## Function that extracts only measurements on mean and standard devition 
## for each paramaeter
...
# Extract only mean and standard deviation for all parameters from test
# data using the function meanStd
...
# Insert a variable SubjectType (label "test") to indicate 
# test data
...
# Extract only mean and standard deviation for all parameters from training
# data using the function meanStd
...
# Insert a variable SubjectType (label "train") to indicate 
# training data 
...
## Create a tidy data set containing mean and standard deviation
## measurements of all parameters in test and training datasets
## averaged by subject ID and activity type and write this tidy data set 
## in to a text file 'tidySet.txt'
